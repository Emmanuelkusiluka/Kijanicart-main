    ...
    <section id="products" className="relative py-32 overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-6">
            ...
            >
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  <h3 className="text-2xl text-white mb-1">{products.marketplace.title}</h3>
                  <p className="text-green-400">{products.marketplace.forLabel}</p>
                </div>
              </div>
              <p className="text-gray-400">
                {products.marketplace.shortDesc}
              </p>
            </motion.button>
            ...
            >
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  <h3 className="text-2xl text-white mb-1">{products.analytics.title}</h3>
                  <p className="text-emerald-400">{products.analytics.forLabel}</p>
                </div>
              </div>
              <p className="text-gray-400">
                {products.analytics.shortDesc}
              </p>
            </motion.button>
          </div>
          ...
          >
            {/* Glow effect */}
            <div className={`absolute -top-24 -right-24 w-48 h-48 rounded-full blur-[100px] ${
              activeProduct === "marketplace" ? "bg-green-500/30" : "bg-emerald-500/30"
            }`} />
            ...
            <div className="relative z-10">
                ...
                {active.features.map((feature, index) => (
                  <div key={index} className="flex items-center gap-3">
                    <div className={`w-1.5 h-1.5 rounded-full ${
                      activeProduct === "marketplace" ? "bg-green-400" : "bg-emerald-400"
                    }`} />
              ...
              <Button 
                size="lg"
                onClick={() => onNavigate("getstarted", { selectedProduct: activeProduct })}
                className={`w-full ${
                  activeProduct === "marketplace"
