...
export function ProductsCircle() {
    ...
    const ProductDetails = ({product}: { product: "marketplace" | "analytics" }) => {
                            ...
                            <div key={index} className="flex items-center gap-3">
                                <div
                                    className={`w-1.5 h-1.5 rounded-full ${
                                        product === "marketplace" ? "bg-green-400" : "bg-emerald-400"
                                    }`}
                                />
    ...
    return (
        <section id="products" className="relative py-12 overflow-hidden">
            {/* Background */}
                    ...
                    <div className="space-y-6">
                        ...
                        >
                            ...
                            <div className="md:hidden">
                                <AnimatePresence>
                                    {activeProduct === "analytics" && (
                                        <ProductDetails product="analytics"/>
                                    )}
                                </AnimatePresence>
                            </div>
                        </motion.div>
                        ...
                        >
                            ...
                            <div className="md:hidden">
                                <AnimatePresence>
                                    {activeProduct === "marketplace" && (
                                        <ProductDetails product="marketplace"/>
                                    )}
                                </AnimatePresence>
                            </div>
