...
export function ModernFooter({ onNavigate }: ModernFooterProps) {
  ...
  return (
    <footer id="contact" className="relative border-t border-neutral-800 bg-neutral-950">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            >
              ...
              <div>
                <div className="text-xl text-white">Kijanicart</div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              {[
                { label: t("footer.marketplace"), page: "products" as PageType },
                { label: t("footer.analytics"), page: "products" as PageType },
                { label: t("footer.pricing"), page: "pricing" as PageType },
                { label: t("footer.enterprise"), page: "getstarted" as PageType }
              ].map((item) => (
                <li key={item.label}>
                  <button
          ...
          <div>
            ...
            <ul className="space-y-4">
              {[
                { label: t("footer.features"), page: "features" as PageType },
                { label: t("footer.blog"), page: "blog" as PageType },
                { label: t("footer.contact"), page: "contact" as PageType }
              ].map((item) => (
                <li key={item.label}>
                  <button
                    onClick={() => onNavigate(item.page)}
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <a href="mailto:hello@kijanicart.com" className="text-gray-400 hover:text-green-400 transition-colors text-sm">
      ...
      <div className="relative overflow-hidden h-40">
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-[35%] whitespace-nowrap pointer-events-none">
      ...
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[800px] h-32 bg-green-500/10 blur-[100px] pointer-events-none" />
    </footer>
  );
}