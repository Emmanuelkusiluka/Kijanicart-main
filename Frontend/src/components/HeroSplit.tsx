...
export function HeroSplit() {
    ...
    return (
        <section className="relative min-h-screen flex items-center overflow-hidden">
            ...
            {/* Glowing orbs */}
            <div
                className="absolute top-1/4 left-1/4 w-96 h-96 bg-green-500/20 rounded-full blur-[120px] animate-pulse"/>
            <div
                className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-emerald-500/20 rounded-full blur-[120px] animate-pulse"
            ...
            <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8 py-32">
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        {/* Badge */}
                        <div
                            className="inline-flex items-center gap-2 px-4 py-2 bg-green-500/10 border border-green-500/30 rounded-full backdrop-blur-sm">
                  ...
                  {t("hero.title2")}
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            <Link to="/getstarted">
                                <Button
                                    size="lg"
                                    className="w-full bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white text-lg px-8 py-6 rounded-2xl group"
                                >
                                    {t("hero.cta1")}
                                    <ArrowRight
                            ...
                            <Link to="/products">
                                <Button
                                    size="lg"
                                    variant="outline"
                                    className="w-full border-green-500/30 text-green-400 hover:bg-green-500/10 hover:text-white text-lg px-8 py-6 rounded-2xl"
                                >
                        ...
                        <div className="flex items-center gap-8 pt-4">
                            <div className="text-center">
                                <div
                                    className="text-3xl bg-gradient-to-r from-green-400 to-emerald-400 bg-clip-text text-transparent">500+
                                </div>
                            ...
                            <div className="text-center">
                                <div
                                    className="text-3xl bg-gradient-to-r from-green-400 to-emerald-400 bg-clip-text text-transparent">100M
                                </div>
                            ...
                            <div className="text-center">
                                <div
                                    className="text-3xl bg-gradient-to-r from-green-400 to-emerald-400 bg-clip-text text-transparent">+63%
                                </div>
                    ...
                    >
                        ...
                        <div
                            className="absolute top-0 right-0 w-[400px] h-[500px] rounded-3xl overflow-hidden border border-green-500/30 shadow-2xl transform rotate-3 hover:rotate-0 transition-transform duration-500">
                            <ImageWithFallback
                            ...
                            />
                            <div
                                className="absolute inset-0 bg-gradient-to-t from-green-900/80 via-transparent to-transparent"/>
                        </div>

                        {/* Secondary Image */}
                        <div
                            className="absolute bottom-0 left-0 w-[300px] h-[350px] rounded-3xl overflow-hidden border border-emerald-500/30 shadow-2xl transform -rotate-3 hover:rotate-0 transition-transform duration-500">
                            <ImageWithFallback
                            ...
                            />
                            <div
                                className="absolute inset-0 bg-gradient-to-t from-emerald-900/80 via-transparent to-transparent"/>
                        </div>

                        {/* Floating badge */}
                        <div
                            className="absolute top-12 left-12 bg-neutral-900/80 backdrop-blur-xl border border-green-500/30 rounded-2xl p-4 shadow-2xl">
