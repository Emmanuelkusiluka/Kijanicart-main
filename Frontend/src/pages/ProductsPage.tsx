            ...
            <section className="relative py-12 overflow-hidden">
                ...
                Kijanicart Family
                        ...
                        <p className="text-xl text-gray-400 max-w-3xl mx-auto">
                            Choose the solution that fits your needs, or combine both for
                            maximum impact
                        </p>
                    </motion.div>
                </div>
            ...
            <section className="relative py-20">
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center mb-32">
                        ...
                        >
                            {[
                                ...
                                },
                                {
                                    ...
                                    desc: "Stock optimization",
                                },
                                {icon: BarChart3, title: "Custom Reports", desc: "Your way"},
                            ].map((item, index) => (
                                <Card
                                    key={index}
                                    className="bg-neutral-900/50 border-neutral-800 hover:border-emerald-500/50 transition-all duration-300"
                                >
                                    <CardContent className="p-6">
                                        <div
                                            className="w-12 h-12 bg-emerald-500/10 rounded-xl flex items-center justify-center mb-4">
                        ...
                        >
                            <div
                                className="w-20 h-20 bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-2xl flex items-center justify-center mb-6">
                                <BarChart3 className="w-10 h-10 text-white"/>
                            </div>
                            <h2 className="text-5xl text-white mb-6">Analytics</h2>
                            <p className="text-xl text-gray-400 mb-8 leading-relaxed">
                                Make data-driven decisions with AI-powered insights. Track
                                everything from inventory to seasonal trends and optimize your
                                operations.
                            </p>
                            ...
                            <div className="space-y-4 mb-8">
                                {[
                                    ...
                                    <div key={index} className="flex items-center gap-3">
                                        <div
                                            className="w-6 h-6 bg-emerald-500/20 rounded-full flex items-center justify-center flex-shrink-0">
                            ...
                            <Link to="/getstarted">
                                <Button
                                    onClick={() =>
                                        onNavigate("getstarted", {selectedProduct: "analytics"})
                                    }
                        ...
                        >
                            ...
                            <div className="space-y-4 mb-8">
                                {[
                                    ...
                                    <div key={index} className="flex items-center gap-3">
                                        <div
                                            className="w-6 h-6 bg-green-500/20 rounded-full flex items-center justify-center flex-shrink-0">
                            ...
                            <Link to="/coming-soon" state={{productName: "Marketplace"}}>
                                <Button
                            ...
                            {[
                                {
                                    ...
                                    desc: "Easy listing & catalog",
                                },
                                {
                                    icon: Users,
                                    title: "Customer Hub",
                                    desc: "Build relationships",
                                },
                                {
                                    icon: Shield,
            ...
            <section className="relative py-32">
                ...
                <div className="relative z-10 mx-auto max-w-4xl px-6 lg:px-8 text-center">
                    <motion.div
                        ...
                        viewport={{once: true}}
                    >
                        <h2 className="text-5xl text-white mb-6">Ready to Get Started?</h2>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            <Link to="/pricing">
                                <Button
                                    className="w-full bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white rounded-2xl px-8"
                                >
                                    View Pricing
                                </Button>
                            </Link>
