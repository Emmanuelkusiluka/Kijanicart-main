        ...
        <div className="min-h-screen bg-neutral-950">
            <section className="relative min-h-screen flex items-center overflow-hidden">
                ...
                <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8 py-20 w-full">
                    ...
                    <span className="px-4 bg-neutral-950 text-gray-500">
                      Or continue with
                    </span>
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <Button
                                        type="button"
                                        variant="outline"
                                        className="border-neutral-800 text-gray-300 hover:bg-neutral-900 hover:border-green-500/50 hover:text-white h-12"
                                    >
                                        <svg
                                    ...
                                    <Button
                                        type="button"
                                        variant="outline"
                                        className="border-neutral-800 text-gray-300 hover:bg-neutral-900 hover:border-green-500/50 h-12 hover:text-white"
                                    >
                                        <svg
                                            className="w-5 h-5 mr-2"
                                            fill="currentColor"
                            ...
                            <div className="relative rounded-3xl overflow-hidden border border-green-500/30">
                                ...
                                <div className="absolute bottom-0 left-0 right-0 p-12">
                                    ...
                                    <p className="text-lg text-gray-300 mb-6">
                                        ...
                                        reach more customers across Africa.
                                    </p>
                                    <div className="flex items-center gap-4">
                                        <div className="flex -space-x-2">
                                            {[1, 2, 3, 4].map((i) => (
                                                <div
                                                    key={i}
                                                    className="w-10 h-10 bg-gradient-to-br from-green-500 to-emerald-600 rounded-full border-2 border-neutral-950 flex items-center justify-center text-white"
                                                >
                                                    {i}
                                                </div>
                                            ))}
