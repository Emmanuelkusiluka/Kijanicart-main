                            ...
                            >
                                <div className="grid lg:grid-cols-2 gap-0">
                                    <div className="relative h-[400px] lg:h-auto overflow-hidden">
                                        ...
                                        />
                                        <div
                                            className="absolute top-4 left-4 px-4 py-2 bg-gradient-to-r from-green-500 to-emerald-600 rounded-full text-sm text-white">
                                            Featured
                                        </div>
                                    </div>
                      ...
                      <span
                        ...
                        {featuredPost.category}
                                        ...
                                        <div className="flex items-center justify-between">
                                            ...
                                            <Button
                                                className="bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white group/btn">
                                                Read More
                                                <ArrowRight
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                            ...
                            >
                                ...
                                >
                                    <div className="relative h-48 overflow-hidden">
                                        ...
                                        />
                                        <div
                                            className="absolute inset-0 bg-gradient-to-t from-neutral-950 via-transparent to-transparent opacity-60"/>
                                    </div>
                      ...
                      <span
                        ...
                        {post.category}
                                        ...
                                        <div
                                            className="flex items-center justify-between pt-4 border-t border-neutral-800">
                        ...
                        <Card className="bg-gradient-to-br from-green-500/10 to-emerald-500/10 border-green-500/30">
                            <CardContent className="p-12 text-center">
                                ...
                                <p className="text-lg text-gray-400 mb-8 max-w-2xl mx-auto">
                                    Get the latest insights, trends, and tips delivered straight to your inbox every
                                    week.
                                </p>
