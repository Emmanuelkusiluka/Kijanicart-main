                        ...
                        {pricingPlans.map((plan, index) => (
                            ...
                            >
                                ...
                                >
                                    {plan.popular && (
                                        <div
                                            className="absolute -top-4 left-1/2 -translate-x-1/2 px-4 py-1 bg-gradient-to-r from-green-500 to-emerald-600 rounded-full text-sm text-white">
                                            Most Popular
                                        </div>
                                    )}
                ...
                <div className="mx-auto max-w-4xl px-6 lg:px-8">
                                ...
                                <Card
                                    ...
                                    <CardContent className="p-6">
                                        <div className="flex items-start gap-4">
                                            <div
                                                className="w-10 h-10 bg-green-500/10 rounded-xl flex items-center justify-center flex-shrink-0">
                    ...
                    >
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            <Link to="/contact">
                                <Button
                                    className="w-full bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white rounded-2xl"
                                >
                                    Contact Sales
                                </Button>
                            </Link>
                            <Link to="/getstarted">
                                <Button
                                    variant="outline"
                                    className="w-full border-green-500/30 text-green-400 hover:bg-green-500/10 hover:text-white rounded-2xl"
                                >
                                    Start Free Trial
                                </Button>
                            </Link>
