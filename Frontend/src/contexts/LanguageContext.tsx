...
const translations = {
    en: {
        ...
        "hero.description": "Power your farm-to-market journey with AI-powered analytics and a thriving marketplace ecosystem.",
        "hero.cta1": "Launch Your Store",
        "hero.cta2": "View Kijanicart Products",
        ...
        "products.analytics.for": "For Agribusiness Intelligence",
